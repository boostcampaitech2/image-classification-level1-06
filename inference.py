...
if __name__ == '__main__':
    ...
    parser.add_argument('--multi_label', type=bool, default=False, help='cross validation (default: False)')
    ...
    assert args.pth_name, "적용하고자 하는 모델 파라미터를 입력해주세요. cross_validation & ensemble 시에는 best 로만 입력해 주세요"
